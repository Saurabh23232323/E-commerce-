...
import { fetchAsyncProductSingle, getProductSingle, getSingleProductStatus } from '../../Stores/Productslice';
import { STATUS } from '../../utils/status';
import Loader from "../../components/Loader/Loader";
import {formatPrice} from "../../utils/helper";
import { addToCart, getCartMessageStatus, setCartMessageOff, setCartMessageOn } from '../../Stores/Cartslice';
              ...
              <div className='product-details font-manrope'>
                ...
                <div className='qty flex align-center my-4'>
                  ...
                  <div className='qty-change flex align-center mx-3'>
                    <button type = "button" className='qty-decrease flex align-center justify-center' onClick={() => decreaseQty()}>
                      <i className='fas fa-minus'><b>-</b></i>
                    </button>
                ...
                <div className='btns'>
                  ...
                  <button type = "button" className='buy-now btn mx-3'>
                    <span className='btn-text'onClick={backk}>buy now</span>
                  </button>
                </div>
              </div>
            </div>
