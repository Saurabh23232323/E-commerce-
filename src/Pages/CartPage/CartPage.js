...
import { getAllCarts, removeFromCart, toggleCartQty, clearCart } from '../../Stores/Cartslice';
        ...
        <div className='cart-ctable'>
          ...
          <div className='cart-cfoot flex align-start justify-between py-3 bg-white'>
            ...
            <div className='cart-cfoot-r flex flex-column justify-end'>
              ...
              <button type = "button" className='checkout-btn text-white bg-orange fs-16' onClick={backk}>Check Out</button>
            </div>
          </div>
        </div>
      </div>
